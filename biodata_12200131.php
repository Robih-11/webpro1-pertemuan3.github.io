...
$Adobe="AAdobe Premiere";
$Language="Languange";
$English="English";
$Japanese="Japanese";
$Social="Social Media";
$School="School";
$Sekolah="Dasar Negeri Ciputat 08";
$Sekolah="Dasar Negeri Ciputat 08 dengan nilai kelulusan 25.60";
$Sekolah="Menengah Pertama Negeri 13 Tangsel  dengan nilai kelulusan 29.0";
$Sekolah="Menengah Pertama Negeri 13 Tangsel  dengan nilai kelulusan 29.0";
$Sekolah="Menengah Kejuruan Letris 1 Indonesia";
$Sekolah="Menengah Kejuruan Letris 1 Indonesia dengan nilai kelulusan 21.0 , jurusan Teknik Komputer Jaringan";
$My="My Story";
$Ceritaku="Ceritaku";
?>
...
<body>
	<!-- Container -->
		<div class="container">
			<div id="colspan"> <!-- colspan mengabungan beberapa kolom sederhana -->
				<img class="center" src="rob.png" width="200px"
				style="border-radius:200px;"-moz-border-radius: 200px;>
			...
			<!-- <li> membuat daftar berurutan -->
				...
				<!-- a/href untuk membuat sebuah link -->
				<a href="https://www.instagram.com/robby11_/"><i class="fa fa-instagram fa-fw large"></i></a>
				<a href="https://twitter.com/Robih_11"><i class="fa fa-twitter fa-fw large"></i></a>
				<a href="https://github.com/Robih-11"><i class="fa fa-github fa-fw large"></i></a>
				<a href="#"><i class="fa fa-git fa-fw large"></i></a>
				<br>
				<br>
				<br>
			<div>&copy; 2021 by Robih
			</div>
		...
		<div class="padding">
			...
			<td style="text-align: justify;">
									...
									<p> 2019-Sekarang	: Anggota Karang Karuna Unit RW & Kelurahan</p>
									<p> 2019-Sekarang	: Ketua Ikatan Remaja Masjid Al-Husna (Pegangsaan 2)</p>
									<hr/>
									<h2><i class="fa fa-futbol-o fa-fw large"></i>Hobby</h2>
									<li>Sepak Bola</li>
									<li>Badminton</li>
									<li>Futsal</li>
									<li>Traveling</li>
